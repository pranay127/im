					...
					<div class="page-content">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<h3 class="header smaller lighter blue">Surface</h3>
										...
										<script>
											$(document).ready(function(){
											    $('[data-toggle="tooltip"]').tooltip(); 
											     ...
											     document.getElementById("surface").className = "active"; 
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php
									            		$query=mysqli_query($conn,"select * from m_surface");
															$count=0;
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="red" data-toggle="tooltip" title="Delete" href="deletesurface.php?id=<?php echo $id;?>">
					...
					<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					        ...
					        <div class="modal-content">
					            <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title" id="myModalLabel">Add New Surface Details</h4>
					            ...
					            <div class="modal-footer">
					                <button type="button" id="AddSurface" class="btn btn-primary">Add</button>
					            </div>
					        </div>
					    </div>
					</div>
					 ...
					 <script type="text/javascript">
						$('.green').click(function () {
						    ...
						    var $input = $('<input>', {
						        ...
						        blur: function() {
						           ...
						           if($valueN!="")
							       {
						           		window.location="editsurface.php?id="+$id+"&"+"txtvalue="+$valueN;
								   }
								   else
								   {
								   		$.confirm({
						...
						$('#AddSurface').click(function () {
							...
							if(name!="")
							{
								window.location="addsurface.php?name="+name;
							}
							else
				          	{
								$.confirm({
