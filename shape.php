				...
				<div class="main-content-inner">
					...
					<div class="page-content">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<h3 class="header smaller lighter blue">Shape</h3>
										...
										<script>
											$(document).ready(function(){
											    ...
											    document.getElementById("shape").className = "active";
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php
									            		$query=mysqli_query($conn,"select * from m_shape");
															$count=0;
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="red" data-toggle="tooltip" title="Delete" href="deleteshape.php?id=<?php echo $id;?>">
					        ...
					        <div class="modal-content">
					            <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title" id="myModalLabel">Add New Shape Details</h4>
					            ...
					            <div class="modal-footer">
					                <button type="button" id="AddShape" class="btn btn-primary">Add</button>
					            </div>
					        </div>
					    </div>
					</div>
				 ...
				 <script type="text/javascript">
						$('.green').click(function () {
						    ...
						    var $input = $('<input>', {
						        ...
						        blur: function() {
						           ...
						           if($valueN!="")
						           {
						           		window.location="editshape.php?id="+$id+"&"+"txtvalue="+$valueN;
						           }
						           else
							          	{
											$.confirm({
						...
						$('#AddShape').click(function () {
							...
							if(name!="")
							{
								window.location="addshape.php?name="+name;
							}
							else
				          	{
								$.confirm({
