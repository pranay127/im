					...
					<div class="page-content">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<h3 class="header smaller lighter blue">Company Details</h3>
										...
										<div class="clearfix">
											<div class="pull-right tableTools-container">
												<div class="btn btn-white btn-primary btn-bold">
													<a class="blue" href="addcompany.php" data-toggle="tooltip" title="Add">
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" data-toggle="tooltip" title="Edit" href="editcompany.php?id=<?php echo $id;?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																	<a class="red" data-toggle="tooltip" title="Delete" href="deltecompany.php?id=<?php echo $id;?>">
