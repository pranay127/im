				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" method="POST" action="addpurchaseprocess.php" class="pull-right">
									<h5 class="header blue lighter bigger"><b>
												<?php if(@isset($_GET['error'])){echo $_GET['error'];} else{echo 'Add Purchase Details';} ?></b> 
											</h5>
								<div class="row">
									<div class="col-sm-6">
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													...
													<select id="LotNo" name="lotno" style="width: 230px;height: 32px; margin-right: 5px;">
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													...
													<input type="text" id="make" name="make" class="form-control" style="width: 230px;height: 32px;" />
									...
									<div class="col-sm-6" style="margin-top: 12px; bottom: 68px">
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													...
													<select id="warehouse" name="warehouse" style="width: 230px;height: 32px;">
									 ...
									 <pre style="background-color: white; border-color: white;border-bottom-color:#87b87f; width:1130px; padding-bottom: 0px;padding-top: 0px;"></pre> 
											...
											if($items)
									      	{
											    ...
											    buttons: {
													...
													additems+='<label class="col-sm-1 control-label no-padding-left" for="form-field-1" style="width: 175px;margin-top:12px;"> Size(mm) <span style="color:red;margin-top:12px;">*</span> </label>';
													additems+='<div class="row">';
														additems+='<div class="col-xs-6">';
															additems+='<div class="input-group input-group-sm">';
																...
																additems+='<input type="number" value="00 "id="size2" name="size2'+$i+'" class="form-control" style="width: 100px;height: 32px;margin-top:12px;" />';
