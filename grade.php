				...
				<div class="main-content-inner">
					...
					<div class="page-content">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<h3 class="header smaller lighter blue">Grade</h3>
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="red" data-toggle="tooltip" title="Delete" href="deletegrade.php?id=<?php echo $id;?>">
					        ...
					        <div class="modal-content">
					            <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title" id="myModalLabel">Add New Grade Details</h4>
					            ...
					            <div class="modal-footer">
					                <button type="button" id="AddGrade" class="btn btn-primary">Add</button>
					            </div>
					        </div>
					    </div>
					</div>
					...
					<script type="text/javascript">
						    ...
						    var $input = $('<input>', {
						        ...
						        blur: function() {
						           ...
						           $valueN=this.value;
							           if($valueN!="")
							           {
							           		window.location="editgrade.php?id="+$id+"&"+"txtvalue="+$valueN;
							           }
							          	else
							          	{
											$.confirm({
						...
						$('#AddGrade').click(function () {
							...
							if(name!="")
							{
								window.location="addgrade.php?name="+name;
							}
							else
				          	{
								$.confirm({
