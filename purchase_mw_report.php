									...
									<div class="col-xs-12">
										...
										<div style="overflow-x:auto;">
											...
											<table id="dynamic-table"  class="table table-striped table-bordered table-hover" >
												...
												<?php
													$q = "select  * from newpurchase where fyId = '$fyId' and companyId = '$cId' and `date`>= '$sdate' and `date`<='$edate' ";
									            		$query=mysqli_query($conn,"select  * from newpurchase where fyId = '$fyId' and companyId = '$cId' and `date`>= '$sdate' and `date`<='$edate' ");
									            		//echo $q;
															$count=0;
