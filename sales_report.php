					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" method="POST" action="sales_mw_report.php" class="pull-right">
								...
								<form class="form-horizontal" method="POST" action="sales_s_report.php" class="pull-right">
