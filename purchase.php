					...
					<div class="page-content">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<h3 class="header smaller lighter blue">Purchase</h3>
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="editpurchase.php?id=<?php echo $id;?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>
																<a class="red" data-toggle="tooltip" title="Delete" href="deletepurchase.php?id=<?php echo $id;?>">
