...
if ($conn->connect_error)
	...
	if(@isset($_POST["btnsubmit"]))
	{
		...
		if($count ==1){
            ...
            if(!$result3){
            header('Location:excess.php?error=Failed to update Purchase');
            }
        }
 ...
 if($result && $result1)
					{
						$_SESSION['Allvalues']='';
						header('Location:excess.php');
							
					}
					else
					{
						header('Location:excess.php?error=Failed to update.');
