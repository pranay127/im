					...
					<div class="page-content">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<h3 class="header smaller lighter blue">Financial Year</h3>
										...
										<div class="clearfix">
											<div class="pull-right tableTools-container">
												<div class="btn btn-white btn-primary btn-bold">
													<a class="blue" href="addfinance.php" data-toggle="tooltip" title="Add">
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php
														$query0 = mysqli_query($conn, "select id from company where companyName ='$company' ");
														$row0 = mysqli_fetch_array($query0);
														$id = $row0["id"];

									            		$query=mysqli_query($conn,"select * from financialyear where companyId = '$id'");
															$count=0;
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" data-toggle="tooltip" title="Edit" href="editfinance.php?id=<?php echo $id;?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" data-toggle="tooltip" title="Delete" href="deletefinance.php?id=<?php echo $id;?>">
