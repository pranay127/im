					...
					<div class="page-content">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<h3 class="header smaller lighter blue">Job And Work</h3>
										...
										<div class="clearfix">
											<div class="pull-right tableTools-container">
												<div class="btn btn-white btn-primary btn-bold">
													<a class="blue" href="addjobwork1.php" data-toggle="tooltip" title="Add">
										...
										<script>
											$(document).ready(function(){
											  document.getElementById("jobwork1").className = "active";    
											});
										</script>
										<div class="table-header">
											Results for "Job And Work"
										</div>
