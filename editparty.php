						...
						<div class="row">
							<div class="col-xs-12">
								...
								<?php
													...
													?>
								<form class="form-horizontal" method="POST" action="editpartyprocess.php" class="pull-right">

									<h5 class="header blue lighter bigger"><b>
												<?php if(@isset($_GET['error'])){echo $_GET['error'];} else{echo 'Edit Party Details';} ?></b> 
											</h5>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text"  name="partyname" value="<?php echo $name ; ?>" class="col-xs-10 col-sm-5">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text"  name="contactperson" value="<?php echo $contactperson ; ?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text"   name="partylocation" value="<?php echo $location ; ?>"  class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="tel"  pattern="[789][0-9]{9}"  value="<?php echo $contactno ; ?>" maxlength="10" id="form-field-1" name="contactno" class="col-xs-10 col-sm-5" />
										</div>
									</div>
