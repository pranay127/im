					...
					<div class="page-content">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<h3 class="header smaller lighter blue">Transporter Details</h3>
										...
										<div class="clearfix">
											<div class="pull-right tableTools-container">
												<div class="btn btn-white btn-primary btn-bold">
													<a class="blue" href="addtransporter.php" data-toggle="tooltip" title="Add">
										...
										<div class="table-header">
											Results for "Transporter Details"
										</div>
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php
									            		$query=mysqli_query($conn,"select * from transporter");
															$count=0;
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" data-toggle="tooltip" title="Edit" href="edittransporter.php?id=<?php echo $id;?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>

																<a class="red" data-toggle="tooltip" title="Delete" href="deletetransporter.php?id=<?php echo $id;?>">
