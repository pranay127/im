			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<form class="form-horizontal" method="POST" action="addjobwork1process.php" class="pull-right">
									<h5 class="header blue lighter bigger"><b>
												<?php if(@isset($_GET['error'])){echo $_GET['error'];} else{echo 'Add JobworkDetails Details';} ?></b> 
											</h5>
							           ...
							           $(document).on('change', 'input', function(){
										    ...
										    for (var i=0;i<options.length;i++){
										       if (options[i].value == $(this).val()) 
										         {
										         	$codeval= $(this).val();
										         	window.location="jobwork1codechange.php?code="+ $codeval;
										         }
										    }
										});
							        });
									...
									<div class="col-sm-6" style="margin-top: 12px;" >
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													<?php if($values[1]){?>
													<input type="text" id="datepicker2" name="date2" value="<?php echo $values[1];?>" class="form-control"  style="width: 230px;height: 32px;" readonly/>
													<?php } else{?>
													<input type="text" id="datepicker2" name="date2" value="" class="form-control"  style="width: 230px;height: 32px;" />
													<?php } ?>
													...
													<select id="LotNo2" name ="lotno2" style="width: 230px;height: 32px; margin-right: 5px;">
														<?php
															if($result22){
																...
																?>
																<option value="<?php echo $id;?>"><?php echo $lno;?></option>
															<?php } } else { ?>
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													...
													<select id="jobwork"  name="jobwork"  class="jobwork" style="width: 230px;height: 32px;">
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													...
													<input type="text" id="size3" name="size3" value="" class="form-control" style="width: 230px;height: 32px; margin-right: 20px;"/>
									...
									<div class="col-sm-6" style="margin-top: 12px;">
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													<?php if($values[10]){?>	
													<input type="text" id="make1" value="<?php echo $values[10];?>" name="make1" class="form-control" style="width: 230px;height: 32px;">
													<?php } else{?>	
													<input type="text" id="make1" value="" name="make1" class="form-control" style="width: 230px;height: 32px;" >
													<?php } ?>
												</div>
											</div>
										</div>
