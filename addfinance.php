							...
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<h5 class="header blue lighter bigger"><b>
												<?php if(@isset($_GET['error'])){echo $_GET['error'];} else{echo 'Add New Finance Details';} ?></b> 
											</h5>
										...
										<div class="row">
											<div class="col-xs-3">
												<div class="input-group input-group-sm">
													<input type="text" id="datepicker"  class="form-control" name='startdate' style="width: 230px;height: 32px;"/>
										...
										<div class="row">
											<div class="col-xs-3" >
												<div class="input-group input-group-sm" style="margin-top: 15px">
													<input type="text" id="datepicker1" class="form-control" name='enddate'   style="width: 230px;height: 32px;"/>
													<span class="input-group-addon" >
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													...
													<input type="text" id="financialyear" name='financialyear'  class="form-control" style="width: 230px;height: 32px; margin-top: 15px" />
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													...
													<input type="text" id="status" name='status' class="form-control" style="width: 230px;height: 32px; margin-top: 15px" />
