					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<?php
													$query=mysqli_query($conn,"select * from warehousemanagement where warehouseId='$id'");
													while($row=mysqli_fetch_array($query))
													{
														...
														$mobile=$row['mobile'];
														$email=$row['email'];
														$respnperson=$row['responsiblePerson'];
														}

													?>
								<form class="form-horizontal" method="POST" action="editwarehouseprocess.php" class="pull-right">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text"  name="warehousename" value="<?php echo $name ; ?>" class="col-xs-10 col-sm-5">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text"  name="resperson" value="<?php echo $respnperson ; ?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
