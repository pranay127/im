					...
					<div class="page-content">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<h3 class="header smaller lighter blue">Lot Details</h3>
										...
										<script>
											$(document).ready(function(){
											    ...
											    document.getElementById("lot").className = "active";
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php
									            		$query=mysqli_query($conn,"select * from lotno");
															$count=0;
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="red" data-toggle="tooltip" title="Delete" href="deletelot.php?id=<?php echo $id;?>">
					        ...
					        <div class="modal-content">
					            <div class="modal-header">
					                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					                 <h4 class="modal-title" id="myModalLabel">Add New Lot Details</h4>
				...
				<script type="text/javascript">
						$('.green').click(function () {
						    ...
						    var $input = $('<input>', {
						        ...
						        blur: function() {
						           ...
						           if($valueN!="")
						           {
						           		window.location="editlot.php?id="+$id+"&"+"txtvalue="+$valueN;
						           }
						           else
							       {
										$.confirm({
						...
						$('#Addlot').click(function () {
							...
							if(lotno!="")
							{
								...
								window.location="addlot.php?lotno="+lotno;
