							...
							<div class="col-xs-12">
								...
								<?php
													...
													while($row=mysqli_fetch_array($query))
													{
														...
														$email=$row['email'];
														$responperson=$row['responsiblePerson'];

														}

													?>
								<form class="form-horizontal" method="POST" action="editcompanyprocess.php" class="pull-right">
											<h5 class="header blue lighter bigger"><b>
												<?php if(@isset($_GET['error'])){echo $_GET['error'];} else{echo 'Edit Company Details';} ?></b> 
											</h5>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text"  name="companyname"  value="<?php echo $name ; ?>" class="col-xs-10 col-sm-5">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="responperson"  value="<?php echo $responperson ; ?>" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									<div class="form-group">
