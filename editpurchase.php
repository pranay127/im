...
<?php
		...
		$sql9 = "SELECT warehouseId,name FROM warehousemanagement";
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form class="form-horizontal" method="POST" action="editpurchaseprocess.php" class="pull-right">
									<h5 class="header blue lighter bigger"><b>
												<?php if(@isset($_GET['error'])){echo $_GET['error'];} else{echo 'Edit Purchase Details';} ?></b> 
											</h5>
								<div class="row">
									<div class="col-sm-6">
									...
									<div class="col-sm-6">
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													<input type="text"  name="code"  class="form-control" value="<?php echo $codeno ?>" style="width: 230px;height: 32px;" readonly/>
												</div>
											</div>
										</div>
									</div>
											...
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													...
													<select name="grade" style="width: 230px;height: 32px;">
															...
															$sql11 = "SELECT m_grade.name,m_grade.id FROM newpurchase INNER JOIN m_grade ON newpurchase.grade =m_grade.Id where purchaseId=".$purchase_id; 
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													...
													<input type="text" name="billno" class="form-control" value="<?php echo $billno ?>" style="width: 230px;height: 32px;" />
									...
									<div class="col-sm-6" style="margin-top: 12px;">
										<label class="col-sm-1 control-label no-padding-left" for="form-field-1" style="width: 100px;"> Make <span style="color:red">*</span> </label>
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">

													<input type="text" name="make" class="form-control" value="<?php echo $make ?>" style="width: 230px;height: 32px;" />
											...
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													...
													<select name="shape" style="width: 230px;height: 32px; ">
															...
															$sql12 = "SELECT m_shape.name,m_shape.id FROM newpurchase INNER JOIN m_shape ON newpurchase.shape =m_shape.Id where purchaseId=".$purchase_id; 
									...
									<div class="col-sm-6" style="margin-top: 12px;">
										<label class="col-sm-1 control-label no-padding-left" for="form-field-1" style="width: 100px;"> Lot No. <span style="color:red">*</span> </label>
												...
												<div class="input-group input-group-sm">
													...
													<select name="lotno" style="width: 230px;height: 32px; margin-right: 5px;">
														<?php
															...
															$sql14 = "SELECT lotno.lotNo,lotno.id FROM newpurchase INNER JOIN lotno ON newpurchase.lotNo =lotno.Id where purchaseId=".$purchase_id; 
											...
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													...
													<select name="surface" style="width: 230px;height: 32px;">
															...
															$sql13 = "SELECT m_surface.name,m_surface.id FROM newpurchase INNER JOIN m_surface ON newpurchase.surface =m_surface.Id where purchaseId=".$purchase_id; 
									...
									<div class="col-sm-6" style="margin-top: 12px;">
										<label class="col-sm-1 control-label no-padding-left" for="form-field-1" style="width: 100px;"> Warehouse  <span style="color:red">*</span> </label>
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">

													<select name="warehouse" style="width: 230px;height: 32px;">
														<?php

															$sql10 = "SELECT warehousemanagement.name,warehousemanagement.warehouseId FROM newpurchase INNER JOIN warehousemanagement ON newpurchase.warehouseId = warehousemanagement.warehouseId where purchaseId=".$purchase_id;
														...
														<option value="<?php echo $id; ?>"><?php echo $warehousename; ?></option>
														...
														<?php	
																...
																?>
																<option value="<?php echo $id;?>"><?php echo $warename;?></option>
																<?php			
																	}	
																?>
												...
												<div class="input-group input-group-sm">
													...
													<select name="transporter" style="width: 230px;height: 32px; margin-right: 5px">
														...
														<?php
															...
															$sql15 = "SELECT transporter.companyName,transporter.venorid FROM newpurchase INNER JOIN transporter ON newpurchase.transporterId =transporter.venorId where purchaseId=".$purchase_id; 
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													...
													<input type="text" name="inhwgt" class="form-control" value="<?php echo $inhweight ?>" style="width: 230px;height: 32px;" />
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													...
													<input type="text" name="lorryno" class="form-control" value="<?php echo $lorryno ?>" style="width: 230px;height: 32px;" />
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													...
													<input type="text" name="invwgt" class="form-control" value="<?php echo $invweight ?>" style="width: 230px;height: 32px;" />
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													...
													<input type="text" name="freightfixed" class="form-control" value="<?php echo $frefixed ?>" style="width: 230px;height: 32px;" />
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group input-group-sm">
													...
													<textarea name="remark" class="autosize-transition form-control"  style="overflow: hidden; word-wrap: break-word; resize: horizontal; width: 400px; height: 100px;"><?php echo $Remarks ?>s</textarea>
